...
This file contains a basic ROS2 C++ publisher node that demonstrates the use of a publisher for sending messages with custom service and broadcaster.
...
This file contains a basic ROS2 C++ test node using Catch2 framework to test the functionality of the publisher node. It has two test cases:
- Test case 1: To check the initializing of publisher
- Test case 2: To check the working of the service
...
**Just run the nodes to test functionality of publisher and talker**
...
ros2 launch beginner_tutorials pubsub_launch.launch.py message_content:="This is Datta"

# Calling the service with modified request message (Terminal 2)
ros2 service call /change_message beginner_tutorials/srv/ChangeString "{message: 'I am Datta Lohith'}"
...
- Terminal 1
   ...
   ros2 launch beginner_tutorials bag_launch.launch.py record_bag:=True stop:=True message_content:="This is Datta"
...
ros2 launch beginner_tutorials bag_launch.launch.py record_bag:=True message_content:="This is Datta"
